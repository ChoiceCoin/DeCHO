...
function Onboarding ({ navigation }) {
    ...
    return(
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor1} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>Congratulations!</Text>
            <Text color={colors.white} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>You Just Connected your Wallet</Text>
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor2} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>Now, you can vote and approve projects!</Text>
            <Text color={colors.white} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>Only Approved projects will be listed</Text>
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor3} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>View listed projects here.</Text>
            <Text color={colors.white} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>If a project reaches its goal. It will be funded, else all funds will be returned to the donors address.</Text>
            <HStack mt={155} alignSelf={'flex-end'}>
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor4} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>Finally, you can earn choice token for performing basic tasks.</Text>
            <Text color={colors.white} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>Ensure, you opt in to the Choice ASA</Text>
            <Pressable onPress={()=>{
                ...
                <Text color={colors.onboardcolor4} fontWeight={'500'} fontSize={'20'} fontFamily={Platform.OS === 'ios' ? 'Gill Sans' : ''}>Vote!</Text>
            </Pressable>
