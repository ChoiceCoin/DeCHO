          ...
          <Modal isOpen={showModal} onClose={() => setShowModal(false)}>
            <Modal.Content w={"95%"}>
              ...
              <Modal.Footer>
                <Button
                  onPress={() => {
                    navigation.navigate('WebviewURL', {source : WALLET_CONNECT_BASE_URL+"?recipientAddress="+address+"&amountToSend="+onChangeValue+"&requestType=makeTxn&txnMethod=asa&deviceType=ios"})
                    setShowModal(false);
                  }}
                  bgColor={colors.teal}
                  colorScheme="teal"
